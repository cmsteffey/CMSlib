...
namespace CMSlib.ConsoleModule
{
    ...
    {
        List<ToastNotification> notifications = new();
        ...
        {
            return CheckToasts(toastShower, DateTime.Now);
        }

        private bool CheckToasts(object sender, DateTime signalTime)
        {
            ...
            _ = Task.Run(() =>
            {
                ...
                if (toShow is not null) Thread.Sleep((int) toastLifetime.TotalMilliseconds);
