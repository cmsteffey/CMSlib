...
{
    /*MAKE PUBLIC, CHANGE CLASS NAME*/
    internal class TemplateModule : BaseModule
    {
        ...
        /*CHANGE CLASS NAME*/
        public TemplateModule(string title, int x, int y, int width, int height) : base(title, x, y, width, height,
            LogLevel.None)
        {
        }
